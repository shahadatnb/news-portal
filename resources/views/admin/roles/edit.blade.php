    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{route('roles.update',$role->id)}}">
            ...
            <div class="form-group">
                ...
                {!! Form::select('permissions[]', $permissions, $role->permissions->pluck('id')->toArray(), ['class'=>'select2-multi form-control','id'=>'role','multiple'=>'multiple']) !!}
            </div>
            {{-- <div class="form-group" >
...
@endsection
@section('css')
<link rel="stylesheet" href="{{url('/public')}}/assets/admin/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css">
@endsection

@section('js')
    <script src="{{url('/public')}}/assets/admin/plugins/bootstrap-tagsinput/bootstrap-tagsinput.js"></script>
